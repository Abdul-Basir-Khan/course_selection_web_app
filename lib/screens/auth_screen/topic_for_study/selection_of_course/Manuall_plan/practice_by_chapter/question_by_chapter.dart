...
class QuestionByChapter extends StatefulWidget {
  const QuestionByChapter({super.key});

  @override
  State<QuestionByChapter> createState() => _QuestionByChapterState();
}

class _QuestionByChapterState extends State<QuestionByChapter> {
  bool isPress=false;
  @override
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            GestureDetector(
              onTap: (){
                navigationProvider.updateIndex(9);
              },
              child: Container(
